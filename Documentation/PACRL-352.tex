...
\begin{abstract}
CYBERNUKE is a roguelite game developed in C\# WPF. You play as an amnesiac cyborg who awakens in the middle of a destroyed futuristic city and must discover who they were and what happened to them. The game combines a post-apocalyptic and cyberpunk setting to create a distinct atmosphere not previously explored by others. The setting of the game is inspired by popular stories such as \emph{Fallout}, \emph{Cyberpunk 2077}, and other games like \emph{FTL: Faster than Light} and the \emph{Megami Tensei} series.
\end{abstract}
}
