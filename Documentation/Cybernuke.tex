...
Refer to Figure 3 in the UML Outline subsection (the subsection below this one) to see a visual representation of this.
...
Refer to Figure 4 and Figure 5 in the UML Outline subsection to see the class-specific markup of the MainMenuView and the functions it contains.
...
Refer to Figure 6 in the UML Outline subsection.
...
Refer to Figure 7 in the UML Outline subsection.
...
Refer to Figure 8 in the UML Outline subsection.
...
This UML contains the Views and Windows that are utilized in the Cybernuke project, as well as the NavigationService interface which is used to actually do the navigation between views:

\begin{figure}[h]
\centering
\includegraphics[height=300px, width=500px]{UML/UML Screenshots for Deliverable/MVVM_views_and_models.png}
\caption{UML for the Views and Windows used in the Cybernuke project}
\label{uml_view}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height=300px, width=500px]{UML/UML Screenshots for Deliverable/MVVM_mainmenuresolution.png}
\caption{This UML shows how resolution was handled for the Cybernuke project}
\label{uml_mainmenuresolution}
\end{figure}

\pagebreak

This UML contains the MainMenuView's UML representation:

\begin{figure}[h]
\centering
\includegraphics[height=350px, width=500px]{UML/UML Screenshots for Deliverable/MVVM_mainmenuview.png}
\caption{UML for the MainMenuView functionality used in the Cybernuke project}
\label{uml_mainmenuview}
\end{figure}

\pagebreak

This UML contains the CombatView's UML representation:

\begin{figure}[h]
\centering
\includegraphics[height=500px, width=500px]{UML/UML Screenshots for Deliverable/MVVM_combatview.png}
\caption{UML for the CombatView functionality used in the Cybernuke project}
\label{uml_combatview}
\end{figure}

\pagebreak

This UML contains the TownView's UML representation:

\begin{figure}[h]
\centering
\includegraphics[height=350px, width=500px]{UML/UML Screenshots for Deliverable/MVVM_townview.png}
\caption{UML for the TownView functionality used in the Cybernuke project}
\label{uml_townview}
\end{figure}

\pagebreak

This UML contains the CutsceneView's UML representation:

\begin{figure}[h]
\centering
\includegraphics[height=350px, width=500px]{UML/UML Screenshots for Deliverable/MVVM_cutsceneview.png}
\caption{UML for the Cutscene functionality used in the Cybernuke project}
\label{uml_cutsceneview}
\end{figure}
