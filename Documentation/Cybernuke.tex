...
The basis of Cybernuke's structure is built on top of the MVVM (Model-View-ViewModel) pattern. Views in this project are essentially the menus or windows that allow the user to actually play the game. For instance, the MainMenuView is functionally and graphically the main menu of the game, and the CombatView is functionally and graphically the GUI and functions used in facilitating combat between the player and npcs.
...
For the combat view, (accessed once more through MainWindow.xaml backend) a list of enemy targets and list of players (main character and companions) is used to track turn order and actions in combat. 
